...
import IconDapur from '../assets/Icon-Dapur.svg';
import IconLaundry from '../assets/Icon-Laundry.svg';
import IconNoSmoking from '../assets/Icon-NoSmoking.svg';
import IconJamMalam from '../assets/Icon-JamMalam.svg';
import IconGender from '../assets/Icon-Gender.svg';

export default function DetailKosMelati({ onNavigateBack }) {
  ...
  const data = {
    name: "Kos Melati Wanita Residence",
    status: "3 Kamar Tersedia",
    statusColor: "bg-green-100 text-green-700",
    price: "1.200.000",
    address: "Jl. Raya Kampus ITS, Sukolilo, Surabaya Timur",
    facilities: [
      { label: "WiFi", icon: IconWifi }, { label: "AC", icon: IconAC },
      { label: "Parkir Motor", icon: IconParkir }, { label: "KM Dalam", icon: IconKMDalam },
      { label: "Dapur", icon: IconDapur }, { label: "Laundry", icon: IconLaundry }
    ],
    rules: [
      { label: "Dilarang Merokok", icon: IconNoSmoking },
      { label: "Jam Malam 23.00", icon: IconJamMalam },
      { label: "Wanita Only", icon: IconGender }
    ]
  };
    ...
    <div className="min-h-screen bg-[#F5F5F5] pb-24 text-gray-800">
      ...
      <div className="w-full max-w-3xl mx-auto bg-white mt-1">
        <div className="w-full h-56 md:h-80 overflow-hidden relative">
          <img src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=1000" className="w-full h-full object-cover" alt="Utama" />
        </div>
        <div className="flex w-full h-16 md:h-24">
          <img src="https://images.unsplash.com/photo-1505693314120-0d443867891c?w=300" className="w-1/4 h-full object-cover border-r border-white" alt="1" />
          <img src="https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=300" className="w-1/4 h-full object-cover border-r border-white" alt="2" />
          ...
          <div className="w-1/4 h-full relative bg-gray-900"><img src="https://images.unsplash.com/photo-1513694203232-719a280e022f?w=300" className="w-full h-full object-cover opacity-50" alt="4" /><div className="absolute inset-0 flex items-center justify-center text-white font-bold">+5 Foto</div></div>
        </div>
      </div>
      ...
      <main className="max-w-3xl mx-auto p-4 md:p-6">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-1.5 text-sm mb-2">
            ...
            <span className="text-gray-500">(1 Ulasan)</span>
          </div>
        ...
        <div className="mb-8 bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="text-sm md:text-base text-gray-600 space-y-3 leading-relaxed">
            <p>Kos Wanita yang tenang dan aman, hanya berjarak 200m dari gerbang ITS. Sangat direkomendasikan untuk mahasiswi yang mencari lingkungan kondusif untuk belajar.</p>
            <p><strong>Detail Lokasi:</strong> {data.address} (Masuk gang sebelah Alfamart, pagar warna putih).</p>
            <p><strong>Fasilitas Kamar:</strong> Setiap kamar sudah *fully furnished* berisi Kasur Springbed, Lemari Pakaian 2 Pintu, Meja Belajar, Kursi, dan AC dingin.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm mb-10">
          ...
          <div className="flex justify-between items-start mb-4">
            <div className="flex items-center gap-3">
              <img src="https://i.pravatar.cc/100?img=5" className="w-12 h-12 rounded-full object-cover" alt="" />
              <div>
                <div className="flex items-center gap-2">
                  <p className="font-bold text-sm md:text-base">Freya Evangeline</p>
            ...
            <span className="text-[11px] text-gray-400 font-medium">1 Jam yang lalu</span>
          </div>
          
          <p className="text-sm font-semibold mb-2">Foto & Video dari Freya</p>
          <div className="flex gap-2 mb-4 overflow-x-auto">
            <img src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=150" className="w-20 h-16 rounded-lg object-cover border" alt="" />
            <img src="https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=150" className="w-20 h-16 rounded-lg object-cover border" alt="" />
          ...
          <p className="text-sm text-gray-600 mb-5 leading-relaxed">Ibu kosnya baik banget, kamarnya bersih, deket banget sama kampus ITS tinggal jalan kaki. Recommended!</p>
          ...
          <div className="bg-[#F5F5F5] border border-gray-100 rounded-lg p-3.5 text-xs text-gray-700 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="flex items-center gap-2"><span className="text-blue-500 text-base">🛒</span> Dekat Superindo (50m)</div>
            <div className="flex items-center gap-2"><span className="text-blue-500 text-base">🚌</span> Dekat Halte Bus (300m)</div>
            <div className="flex items-center gap-2"><span className="text-blue-500 text-base">🧺</span> Laundry Express (100m)</div>
            <div className="flex items-center gap-2"><span className="text-blue-500 text-base">💊</span> Apotek 24 Jam (300m)</div>
          </div>
        </div>
      </main>
