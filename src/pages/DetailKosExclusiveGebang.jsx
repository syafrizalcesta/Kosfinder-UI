...
export default function DetailKosExclusiveGebang({ onNavigateBack }) {
  ...
  const data = {
    name: "Kos Exclusive Gebang",
    status: "Penuh / Tidak Tersedia",
    statusColor: "bg-red-100 text-red-700",
    price: "1.500.000",
    address: "Jl. Gebang, Sukolilo, Surabaya Timur",
    facilities: [
      { label: "WiFi", icon: IconWifi }, { label: "AC", icon: IconAC },
      { label: "Smart TV", icon: IconTV }, { label: "Kulkas", icon: IconKulkas },
      { label: "KM Dalam", icon: IconKMDalam }, { label: "Parkir Mobil", icon: IconParkir },
      { label: "Security", icon: IconSecurity }
    ],
    rules: [
      { label: "Bebas Jam Malam", icon: IconBebasJam },
      { label: "Dilarang Narkoba", icon: IconNoDrugs },
      { label: "Lapor Tamu", icon: IconNoGuests }
    ]
  };
    ...
    <div className="min-h-screen bg-[#F5F5F5] pb-24 text-gray-800">
      ...
      <div className="w-full max-w-3xl mx-auto bg-white mt-1">
        <div className="w-full h-56 md:h-80 overflow-hidden relative">
          <img src="https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=1000" className="w-full h-full object-cover" alt="Utama" />
        </div>
        <div className="flex w-full h-16 md:h-24">
          ...
          <div className="w-1/4 h-full relative bg-gray-900"><img src="https://images.unsplash.com/photo-1513694203232-719a280e022f?w=300" className="w-full h-full object-cover opacity-50" alt="4" /><div className="absolute inset-0 flex items-center justify-center text-white font-bold">+2 Foto</div></div>
        </div>
      </div>
      ...
      <main className="max-w-3xl mx-auto p-4 md:p-6">
        ...
        <div className="mb-8 bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="text-sm md:text-base text-gray-600 space-y-3 leading-relaxed">
            <p>Kos tipe eksklusif dengan fasilitas lengkap bak hotel berbintang. Sangat cocok untuk Anda yang mengutamakan privasi, keamanan, dan kenyamanan tingkat tinggi.</p>
            <p><strong>Detail Lokasi:</strong> {data.address} (Masuk jalan utama Gebang, gedung putih besar berpagar tinggi).</p>
            <p><strong>Fasilitas Kamar:</strong> Bed Queen Size, Smart TV 42", Kulkas Mini, Lemari Pakaian Premium, Meja Kerja Luas, dan AC 1 PK.</p>
          </div>
        </div>

        <section className="mb-8">
          <h2 className="text-lg font-bold mb-4">Fasilitas Premium</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm mb-10">
          ...
          <div className="flex justify-between items-start mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <p className="font-bold text-sm md:text-base">Kevin Sanjaya</p>
            ...
            <span className="text-[11px] text-gray-400 font-medium">2 Hari yang lalu</span>
          </div>
          
          <p className="text-sm font-semibold mb-2">Foto dari Kevin</p>
          <div className="flex gap-2 mb-4 overflow-x-auto">
            <img src="https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=150" className="w-20 h-16 rounded-lg object-cover border" alt="" />
            <img src="https://images.unsplash.com/photo-1505693314120-0d443867891c?w=150" className="w-20 h-16 rounded-lg object-cover border" alt="" />
          </div>

          <p className="text-sm text-gray-600 mb-5 leading-relaxed">Harga emang nggak bohong, fasilitasnya juara. Parkiran mobil luas dan aman dijaga security 24 jam.</p>
          ...
          <div className="bg-[#F5F5F5] border border-gray-100 rounded-lg p-3.5 text-xs text-gray-700 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="flex items-center gap-2"><span className="text-blue-500 text-base">☕</span> Dekat Excelso Cafe (200m)</div>
            <div className="flex items-center gap-2"><span className="text-blue-500 text-base">💪</span> Dekat Fitness Center (150m)</div>
            <div className="flex items-center gap-2"><span className="text-blue-500 text-base">💳</span> ATM Center (100m)</div>
          </div>
        </div>
      </main>
